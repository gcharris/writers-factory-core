...
- **`scene-analyzer-test-thriller`**: Score scenes 0-100 using your quality criteria
...
- **`scene-enhancer-test-thriller`**: Make surgical fixes to match your voice
  - 8-pass ritual for systematic improvement
  - Focuses on your anti-patterns
  - Preserves your intent while elevating craft

- **`character-validator-test-thriller`**: Check character consistency
...
- **`scene-writer-test-thriller`**: Write new scenes in your voice
  - Generates prose matching your style
  - Uses story knowledge from NotebookLM
  - Avoids your anti-patterns

- **`scene-multiplier-test-thriller`**: Generate 5 variations of a scene
  - Verbalized sampling approach
  - Explores different narrative choices
  - All variations maintain voice

- **`scaffold-generator-test-thriller`**: Expand outlines using your story knowledge
...
```bash
# Analyze a scene
claude skill scene-analyzer-test-thriller "path/to/scene.md"

# Enhance a scene
claude skill scene-enhancer-test-thriller "path/to/scene.md"

# Generate scene variations
claude skill scene-multiplier-test-thriller "path/to/scene.md"
```
...
2. **Analyze**: Use `scene-analyzer-test-thriller` to score scenes
3. **Enhance**: Use `scene-enhancer-test-thriller` to improve low-scoring scenes
4. **Write**: Use `scene-writer-test-thriller` to draft new scenes
