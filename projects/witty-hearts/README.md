...
- **`scene-analyzer-witty-hearts`**: Score scenes 0-100 using your quality criteria
...
- **`scene-enhancer-witty-hearts`**: Make surgical fixes to match your voice
  - 8-pass ritual for systematic improvement
  - Focuses on your anti-patterns
  - Preserves your intent while elevating craft

- **`character-validator-witty-hearts`**: Check character consistency
...
- **`scene-writer-witty-hearts`**: Write new scenes in your voice
  - Generates prose matching your style
  - Uses story knowledge from NotebookLM
  - Avoids your anti-patterns

- **`scene-multiplier-witty-hearts`**: Generate 5 variations of a scene
  - Verbalized sampling approach
  - Explores different narrative choices
  - All variations maintain voice

- **`scaffold-generator-witty-hearts`**: Expand outlines using your story knowledge
...
```bash
# Analyze a scene
claude skill scene-analyzer-witty-hearts "path/to/scene.md"

# Enhance a scene
claude skill scene-enhancer-witty-hearts "path/to/scene.md"

# Generate scene variations
claude skill scene-multiplier-witty-hearts "path/to/scene.md"
```
...
2. **Analyze**: Use `scene-analyzer-witty-hearts` to score scenes
3. **Enhance**: Use `scene-enhancer-witty-hearts` to improve low-scoring scenes
4. **Write**: Use `scene-writer-witty-hearts` to draft new scenes
